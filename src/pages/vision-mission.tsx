          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
            <div className="max-w-2xl backdrop-blur-sm bg-primary-900/20 p-8 rounded-2xl border border-primary-500/10">
              ...
              <p className="fade-in mt-6 text-lg leading-8 text-gray-300 md:text-xl">
                Our commitment to creating sustainable, healthy environments through innovation and community engagement.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8">
            <div className="relative lg:col-start-1">
              <div className="relative mb-8 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:gap-8">
                <div className="fade-in-left group relative rounded-2xl bg-primary-50 p-8 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                  ...
                  <div className="pt-4">
                    <h2 className="text-base font-semibold uppercase tracking-wider text-primary-600">Our Vision</h2>
                    <p className="mt-2 text-3xl font-extrabold tracking-tight text-gray-900 group-hover:text-primary-600 transition-colors duration-300">
                ...
                <div className="fade-in-right group relative rounded-2xl bg-primary-50 p-8 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                  <div className="absolute -top-4 left-4 transition-transform duration-300 group-hover:scale-110">
                    <span className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-primary-600 text-white shadow-lg ring-4 ring-white">
                      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="pt-4">
                    <h2 className="text-base font-semibold uppercase tracking-wider text-primary-600">Our Mission</h2>
                    <p className="mt-2 text-3xl font-extrabold tracking-tight text-gray-900 group-hover:text-primary-600 transition-colors duration-300">
          ...
          <div className="mt-16">
            <div className="grid gap-12 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-12">
              {highlights.map((highlight, index) => (
                ...
                >
                  <div className="relative rounded-2xl bg-white p-8 shadow-lg transition-all duration-300 group-hover:shadow-xl group-hover:-translate-y-1">
                    <div className="absolute -top-4 left-4 transition-transform duration-300 group-hover:scale-110">
                      <span className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-primary-600 text-white shadow-lg ring-4 ring-white">
                        {highlight.icon}
                      </span>
                    ...
                    <div className="pt-4">
                      ...
                      <p className="mt-4 text-lg text-gray-500">{highlight.description}</p>
                    </div>
                  </div>
                </div>
              ))}
